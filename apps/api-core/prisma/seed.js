...
const USERS = [
    { id: 'user_aza8_admin', email: 'aza8_admin@aza8.com', name: 'Aza8 Admin', type: 'HUB' },
    { id: 'user_aza8_support', email: 'aza8_support@aza8.com', name: 'Aza8 Support', type: 'HUB' },
    { id: 'user_owner_alpha', email: 'owner.alpha@client.com', name: 'Owner Alpha', type: 'PORTAL' },
    { id: 'user_manager_alpha', email: 'manager.alpha@client.com', name: 'Manager Alpha', type: 'PORTAL' },
    { id: 'user_member_alpha', email: 'member.alpha@client.com', name: 'Member Alpha', type: 'PORTAL' },
    { id: 'user_supplier_alpha', email: 'supplier.alpha@client.com', name: 'Supplier Alpha', type: 'PORTAL' },
    { id: 'user_owner_beta', email: 'owner.beta@client.com', name: 'Owner Beta', type: 'PORTAL' },
    { id: 'user_member_beta', email: 'member.beta@client.com', name: 'Member Beta', type: 'PORTAL' }
];
const ROLES = [
...
async function main() {
    ...
    for (const role of ROLES) {
        await prisma.role.upsert({
            ...
            create: { key: role.key, scope: role.scope, name: role.name, description: role.name }
        });
    }
